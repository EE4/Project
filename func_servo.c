...
void SERVO_ISR(void) {
    if (PIR2bits.TMR3IF == 1) {
        ...
        servo_counter = (servo_counter + 1) % 40;
        if (servo_counter == 0) { 
            TMR3H = 230;
        ...
        LATBbits.LATB6 = (servo_setpoint[0] > servo_counter);
        //LATBbits.LATB5 = (servo_setpoint[1] > servo_counter);
        //LATBbits.LATB4 = (servo_setpoint[2] > servo_counter);
        /**********************************************/
