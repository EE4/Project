...
# Source Files
SOURCEFILES=config.c func_pwm.c main.c p1_tapping_fsm.c p2_tapping_fsm.c func_audio.c func_score.c feedback_fsm.c display_pattern_fsm.c func_rand.c func_display.c mode3_fsm.c general_fsm.c
