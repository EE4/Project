...
# Source Files
SOURCEFILES=config.c func_pwm.c main.c p1_tapping_fsm.c p2_tapping_fsm.c func_audio.c func_score.c feedback_fsm.c display_pattern_fsm.c func_rand.c func_display.c mode_2.c mode_1.c mode3_fsm.c
...
${OBJECTDIR}/mode_2.p1: mode_2.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/mode_2.p1.d 
	@${RM} ${OBJECTDIR}/mode_2.p1 
	${MP_CC} --pass1 $(MP_EXTRA_CC_PRE) --chip=$(MP_PROCESSOR_OPTION) -Q -G  -D__DEBUG=1 --debugger=none  --double=24 --float=24 --emi=wordwrite --opt=default,+asm,+asmfile,-speed,+space,-debug --addrqual=ignore --mode=free -P -N255 --warn=-3 --asmlist --summary=default,-psect,-class,+mem,-hex,-file --codeoffset=0x800 --output=default,+inhx032 --runtime=default,+clear,+init,-keep,-no_startup,+download,+config,+clib,-plib --output=-mcof,+elf:multilocs --stack=compiled:auto:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"    -o${OBJECTDIR}/mode_2.p1  mode_2.c 
	@-${MV} ${OBJECTDIR}/mode_2.d ${OBJECTDIR}/mode_2.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/mode_2.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
